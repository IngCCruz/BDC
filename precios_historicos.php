...
<body>
    ...
    <table>
        <th>Producto</th><th>Fecha</th><th>Horneada</th><th>Cantidad</th><th>Importe</th>
        <form method="POST">
        <tr>
            <td>
                <select name="idProducto"> 
    ...
    <?php 
        if(isset($_POST["submit2"])) {
            if(empty($_POST["Fecha"]) || empty($_POST["Horneada"]) || empty($_POST["cantidad"]) || empty($_POST["precio"])){
